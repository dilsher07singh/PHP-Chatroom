...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        function showMessage(nameStr, contentStr, color) {
                ...
                //got to change however for hyperlink for insurance
                var hyperlinkunder = /((https|http)?:\/\/[^\s]+)/g;
                //get sting value from this and keep changing to underline
                //make sure to underline using this method and keep chaniging here and there
                contentStr = contentStr.replace(hyperlinkunder, '<a text-decoration="underline" target="blank" href="$1">$1</a>');
    ...
    <svg width="800px" height="2000px"
     ...
     >
        ...
        <rect width="520" height="2000" style="fill:black;stroke:blue;stroke-width:5"/>
        <text x="260" y="40" style="fill:green;font-size:32px;font-weight:bold;text-anchor:middle">Chat Window Results</text> 
